    ...
    <AnimatePresence>
      {visible && (
        <motion.div
          ...
          className="fixed bottom-[max(5.5rem,calc(env(safe-area-inset-bottom)+5rem))] left-[max(1.25rem,env(safe-area-inset-left))] right-[max(1.25rem,env(safe-area-inset-right))] z-50 sm:left-auto sm:right-[max(1.25rem,env(safe-area-inset-right))] sm:w-[340px] lg:bottom-[max(1.25rem,calc(env(safe-area-inset-bottom)+0.75rem))]"
        >
