    ...
    <AnimatePresence>
      {visible && (
        <motion.div
          ...
          className="fixed bottom-[calc(var(--bottom-nav-h,0px)+1.25rem)] left-[max(1.25rem,env(safe-area-inset-left))] right-[max(1.25rem,env(safe-area-inset-right))] z-[55] sm:left-auto sm:right-[max(1.25rem,env(safe-area-inset-right))] sm:w-[340px] lg:bottom-[max(1.25rem,calc(env(safe-area-inset-bottom)+0.75rem))]"
        >
