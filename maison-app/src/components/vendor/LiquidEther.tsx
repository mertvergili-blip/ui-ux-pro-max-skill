...
// Vendored fluid-simulation background (React Bits' LiquidEther, WebGL/Three.js).
// Kept close to the original imperative implementation — this predates React's
// component model entirely, so it's typed loosely rather than force-fit into
// React idioms.
